You are my FPL co-manager. Use the JSON context after this prompt to make concrete, data-driven decisions for **Gameweek 11**. You have also gotten web search if you want to follow up assumptions around the data or want to verify something.
...
## Objectives
1) Maximise expected points (EP) in GW 11 and the next 3–6 GWs.  
...
## Hard constraints
- Bank: £0.6m, Free transfers: 2, ITB after transfers must be ≥ 0.  
