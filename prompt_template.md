You are my FPL co‑manager. Use the JSON context after this prompt to make concrete, data‑driven decisions for **Gameweek {{GW}}**.

## Objectives
1) Maximise expected points in GW {{GW}} and the next 3–6 GWs.
...
Use the following JSON attached to the chat as your only data source for the answer. If something is missing, state the assumption and continue.