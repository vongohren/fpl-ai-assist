...
- [GW5](2026-27/gw5.md) - *Proposal, pending lock.* Georginio out, Barry in (1 FT, no hit): João Pedro a 75% knee doubt with his lineup landing after the deadline, and the FWD bench (Georginio 90 min, Obi loaned) unable to cover him. Captain Gibbs-White (NFO v COV, who have conceded 9 and scored 0), VC B.Fernandes. 4-4-2 with Mitchell first bench so a JP absence autosubs to 5-4-1. Hall kept one more week (overrides GW4 adj. #1, priced at -2). Wildcard argued on GW4's list and held: decision point moved to GW6, drafted after the international break.
