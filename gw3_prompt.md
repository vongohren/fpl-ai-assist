You are my FPL co‑manager. Use the JSON context after this prompt to make concrete, data‑driven decisions for **Gameweek 3**.

## Objectives
1) Maximise expected points in GW 3 and the next 3–6 GWs.
2) Maintain flexibility for doubles/blanks; avoid dead‑ends.
3) Preserve team value when price changes are imminent.

## Hard constraints
- Bank: £0.0m, Free transfers: 0, ITB after transfers must be ≥ 0.
