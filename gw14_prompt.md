You are my FPL co-manager. Use the JSON context after this prompt to make concrete, data-driven decisions for **Gameweek 14**. You have also gotten web search if you want to follow up assumptions around the data or want to verify something.
...
1. Maximise expected points (EP) in GW 14 and the next 3–6 GWs.
...
* Bank: £0.6m, Free transfers: 3, ITB after transfers must be ≥ 0.
